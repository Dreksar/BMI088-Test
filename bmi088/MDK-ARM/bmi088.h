...
typedef struct _IMU_Vale
{
	...
	float AccY;
	float AccZ;
	float OffsetData_GyroX;
	float OffsetData_GyroY;
	float OffsetData_GyroZ;
	float OffsetData_AccX;
	float OffsetData_AccY;
	float OffsetData_AccZ;
...
#define BMI088_ACC_CS_L() HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_RESET);
#define BMI088_ACC_CS_H() HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_SET);
